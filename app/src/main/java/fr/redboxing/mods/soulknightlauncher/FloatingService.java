...
public class FloatingService extends Service {
    ...
    final String TAG = "SOUL KNIGHT JNI MOD"; //Tag for logcat
    ...
    public void onCreate() {
      ...
      /*  handler.post(new Runnable() {
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            NotificationChannel notificationChannel = new NotificationChannel(CHANNEL_ID, "Soul Knight JNI Menu", NotificationManager.IMPORTANCE_HIGH);
            notificationChannel.setSound(null, null);
            notificationManager.createNotificationChannel(notificationChannel);
            Notification.Builder builder = new Notification.Builder(this, CHANNEL_ID);
            builder.setContentTitle("Soul Knight JNI Menu").setContentText("Soul Knight JNI Menu").setSmallIcon(R.drawable.ic_launcher_foreground);
    ...
    private void initFloating() {
        ...
        int iparams = Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O ? WindowManager.LayoutParams.TYPE_APPLICATION_OVERLAY : WindowManager.LayoutParams.TYPE_PHONE;
    ...
    private void Switch(final int featureNum, final String featureName) {
        ...
        switchR.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
                ...
                Preferences.changeBool(featureName, featureNum, isChecked);
            }
        });
        if (featureNum >= 1000)
    ...
    private void ButtonOnOff(final int featureNum, String featureName) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Preferences.changeBool(finalFeatureName, featureNum, isActive2);
