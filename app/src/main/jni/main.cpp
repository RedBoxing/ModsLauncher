...
extern "C"
JNIEXPORT void JNICALL Java_fr_redboxing_mods_soulknightlauncher_NativeLibrary_changeFeature(JNIEnv *env, jclass thisObj, jobject ctx, jint feature, jint value, jboolean boolean, jstring str) {
...
extern "C"
JNIEXPORT void JNICALL Java_fr_redboxing_mods_soulknightlauncher_NativeLibrary_init(JNIEnv * env, jclass obj, jobject thiz){
    MakeToast(env, thiz, OBFUSCATE("<b><font color=#ff0000>Mod by RedBoxing</font></b>"));
}

extern "C"
JNIEXPORT jstring JNICALL Java_fr_redboxing_mods_soulknightlauncher_NativeLibrary_getTitle(JNIEnv * env, jclass obj){
    return env->NewStringUTF(OBFUSCATE("<b>SOUL KNIGHT JNI MOD</b>"));
}

extern "C"
JNIEXPORT jstring JNICALL Java_fr_redboxing_mods_soulknightlauncher_NativeLibrary_getHeading(JNIEnv * env, jclass obj){
...
extern "C"
JNIEXPORT jstring JNICALL Java_fr_redboxing_mods_soulknightlauncher_NativeLibrary_getIcon(JNIEnv * env, jclass obj){
...
extern "C"
JNIEXPORT jstring JNICALL Java_fr_redboxing_mods_soulknightlauncher_NativeLibrary_getIconWebViewData(JNIEnv * env, jclass obj){
    return NULL;
}

extern "C"
JNIEXPORT jobjectArray JNICALL Java_fr_redboxing_mods_soulknightlauncher_NativeLibrary_getFeatureList(JNIEnv *env, jclass jobj){
    // Usage:
    // Category_(text)
