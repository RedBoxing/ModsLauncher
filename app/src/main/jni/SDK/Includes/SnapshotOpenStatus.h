...
class SnapshotOpenStatus
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "", "SnapshotOpenStatus"));
	}
	...
	template <typename T = uintptr_t> static T& VALID_WITH_CONFLICT() {
		return *(T*)((uintptr_t)StaticClass()->static_fields + 0x0);
	}
