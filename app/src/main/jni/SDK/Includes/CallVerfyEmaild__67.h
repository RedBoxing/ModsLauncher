...
class CallVerfyEmaild67
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "", "<CallVerfyEmail>d__67"));
	}
	...
	template <typename T = void> T MoveNext() {
		return ((T (*)(CallVerfyEmaild67*))(Il2CppBase() + 0x16F24F0))(this);
	}
	template <typename T = void> T SetStateMachine(uintptr_t stateMachine) {
		return ((T (*)(CallVerfyEmaild67*, uintptr_t))(Il2CppBase() + 0x16F24F8))(this, stateMachine);
	}
