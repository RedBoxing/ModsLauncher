...
public: 
	...
	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "", "<Init>d__45"));
	}
	...
	template <typename T = void> T MoveNext() {
		return ((T (*)(Initd45*))(Il2CppBase() + 0x16F25AC))(this);
	}
	template <typename T = void> T SetStateMachine(uintptr_t stateMachine) {
		return ((T (*)(Initd45*, uintptr_t))(Il2CppBase() + 0x16F25B4))(this, stateMachine);
	}
