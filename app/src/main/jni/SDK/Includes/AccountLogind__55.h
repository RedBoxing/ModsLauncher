...
class AccountLogind55
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "", "<AccountLogin>d__55"));
	}
	...
	template <typename T = void> T MoveNext() {
		return ((T (*)(AccountLogind55*))(Il2CppBase() + 0x16F2490))(this);
	}
	template <typename T = void> T SetStateMachine(uintptr_t stateMachine) {
		return ((T (*)(AccountLogind55*, uintptr_t))(Il2CppBase() + 0x16F2498))(this, stateMachine);
	}
