...
class ChangePasswordd51
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "", "<ChangePassword>d__51"));
	}
	...
	template <typename T = Il2CppString*> T& oldpassword() {
	...
	template <typename T = void> T MoveNext() {
		return ((T (*)(ChangePasswordd51*))(Il2CppBase() + 0x16F2504))(this);
	}
	template <typename T = void> T SetStateMachine(uintptr_t stateMachine) {
		return ((T (*)(ChangePasswordd51*, uintptr_t))(Il2CppBase() + 0x16F250C))(this, stateMachine);
	}
