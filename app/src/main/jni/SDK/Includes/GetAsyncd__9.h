...
public: 
	...
	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "", "<GetAsync>d__9"));
	}
	...
	template <typename T = void> T MoveNext() {
		return ((T (*)(GetAsyncd9*))(Il2CppBase() + 0x14F69A4))(this);
	}
	template <typename T = void> T SetStateMachine(uintptr_t stateMachine) {
		return ((T (*)(GetAsyncd9*, uintptr_t))(Il2CppBase() + 0x14F69AC))(this, stateMachine);
	}
