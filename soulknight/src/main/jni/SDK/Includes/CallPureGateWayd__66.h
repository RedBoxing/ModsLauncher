...
class CallPureGateWayd66
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "", "<CallPureGateWay>d__66"));
	}
	...
	template <typename T = void> T MoveNext() {
		return ((T (*)(CallPureGateWayd66*))(Il2CppBase() + 0x16F24B8))(this);
	}
	template <typename T = void> T SetStateMachine(uintptr_t stateMachine) {
		return ((T (*)(CallPureGateWayd66*, uintptr_t))(Il2CppBase() + 0x16F24C0))(this, stateMachine);
	}
