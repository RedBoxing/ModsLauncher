...
public: 
	...
	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "ChillyRoomAccount", "EmailUrlConst"));
	}
	...
	template <typename T = Il2CppString*> static T get_ServerPath() {
		return ((T (*)(void *))(Il2CppBase() + 0x1E749B4))(0);
	}
	template <typename T = Il2CppString*> static T get_Path() {
		return ((T (*)(void *))(Il2CppBase() + 0x1E741C4))(0);
	}
