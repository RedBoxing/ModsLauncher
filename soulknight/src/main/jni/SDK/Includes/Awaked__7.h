...
public: 
	...
	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "", "<Awake>d__7"));
	}
	...
	template <typename T = void> T MoveNext() {
		return ((T (*)(Awaked7*))(Il2CppBase() + 0x16F2434))(this);
	}
	template <typename T = void> T SetStateMachine(uintptr_t stateMachine) {
		return ((T (*)(Awaked7*, uintptr_t))(Il2CppBase() + 0x16F243C))(this, stateMachine);
	}
