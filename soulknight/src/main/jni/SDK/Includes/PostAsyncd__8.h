...
public: 
	...
	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "", "<PostAsync>d__8"));
	}
	...
	template <typename T = void> T MoveNext() {
		return ((T (*)(PostAsyncd8*))(Il2CppBase() + 0x14F69B4))(this);
	}
	template <typename T = void> T SetStateMachine(uintptr_t stateMachine) {
		return ((T (*)(PostAsyncd8*, uintptr_t))(Il2CppBase() + 0x14F69BC))(this, stateMachine);
	}
