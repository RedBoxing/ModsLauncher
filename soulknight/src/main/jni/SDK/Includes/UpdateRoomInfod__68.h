...
class UpdateRoomInfod68
{
public: 

	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "", "<UpdateRoomInfo>d__68"));
	}
	...
	template <typename T = uintptr_t> T& remoteResult5__2() {
	...
	template <typename T = void> T MoveNext() {
		return ((T (*)(UpdateRoomInfod68*))(Il2CppBase() + 0x16F2744))(this);
	}
	template <typename T = void> T SetStateMachine(uintptr_t stateMachine) {
		return ((T (*)(UpdateRoomInfod68*, uintptr_t))(Il2CppBase() + 0x16F274C))(this, stateMachine);
	}
