...
public: 
	...
	static Il2CppClass *StaticClass() {
		return (Il2CppClass *)(Il2Cpp::GetClass("Assembly-CSharp.dll", "", "<Download>d__1"));
	}
	...
	template <typename T = void> T MoveNext() {
		return ((T (*)(Downloadd1*))(Il2CppBase() + 0x16F1ADC))(this);
	}
	template <typename T = void> T SetStateMachine(uintptr_t stateMachine) {
		return ((T (*)(Downloadd1*, uintptr_t))(Il2CppBase() + 0x16F1AE4))(this, stateMachine);
	}
